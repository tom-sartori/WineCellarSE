...
public class Advertising implements Entity<Advertising> {
	...
	/**
	 * The user should not be able to set the id, it is automatically generated by the database. He should not modify the number of views or the price, set isActive and isPayed.
	 */
